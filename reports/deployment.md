...
3.860 THB/hour — roughly **1.93 THB per month** for the scorer, **5.79** for all three
scheduled jobs, and **~7.70** once storage and the container registry are counted.
