...
Fuller detail, including the leakage traps this dataset contains and the baselines the model
must beat, is in [`DESIGN.md`](DESIGN.md) and [`PROPOSAL-full.md`](PROPOSAL-full.md).
